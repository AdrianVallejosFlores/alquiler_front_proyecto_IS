...
function PageContent() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-start bg-white px-4 sm:px-6 pt-6"> {/* Cambié el justify-center por justify-start y añadí pt-6 */}
