          ...
          accordions: [
            {
              ...
              actions: [
                { label: 'Registrarme como Fixer', href: '/registro', type: 'primary' }
              ]
            },
            {
        ...
        pageData: { 
            ...
            accordions: [
                ...
                },
                {
                    ...
                    actions: [{ label: 'Registrarme como Fixer', href: '/registro', type: 'primary' }]
                }
            ] 
        } 
      },
                ...
                accordions: [
                    {
                        ...
                        bullets: ['Chat en vivo (8am-10pm)', 'Email: servineobol@gmail.com', 'WhatsApp disponible'],
...
export default function PanelAyuda() {
  ...
  const handleSidebarClick = (catKey: string, subItem?: { id: string; title: string; pageData: PageData }) => {
