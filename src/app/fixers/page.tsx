...
import VisualPortfolioBridge from "./components/VisualPortfolioBridge";
import PromocionPageClient from "@/app/epic_PromocionProveedor/PromocionPage.client";
...
export default async function FixerDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-6">
      ...
      {/* 🔽 Aquí, justo debajo del "Gestiona tu perfil de Fixer" 🔽 */}
      <PromocionPageClient fixerId={id} />
    </div>
  );
}