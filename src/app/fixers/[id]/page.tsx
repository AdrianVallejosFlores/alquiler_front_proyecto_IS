...
// 👇 IMPORTANTE: Importamos el widget de trabajos desde su ruta actual
...
interface FixerData {
  ...
  memberSince?: string;
  createdAt?: string; // Fallback para fecha
  ...
  categories?: string[]; // Fallback antiguo
}
...
export default async function FixerDetailPage({ params }: PageProps) {
  ...
  // Obtenemos la profesión principal
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-6">
      ...
      {/* --- CAJA 3: Historial de Trabajos (NUEVA) --- */}
      {/* Usamos las mismas clases de estilo para mantener consistencia visual */}
      <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
