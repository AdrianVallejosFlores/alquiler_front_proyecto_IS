...
const CancelarTrabajoContent: React.FC = () => {
  ...
  //const trabajoParams = buildTrabajoFromParams(sp);
  //const trabajoParams = useMemo(() => buildTrabajoFromParams(sp), [sp]);

useEffect(() => {
    const id = sp.get("id");
    const providerName = sp.get("proveedor") || "Proveedor no especificado";
  ...
  return (
    <div className="min-h-screen bg-white py-0 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl p-0">
