    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-lg rounded-xl">
          <DialogHeader>
            <DialogTitle>Configuración para notificaciones (RECODE)</DialogTitle>
            <DialogDescription>Guarda información del Request y del Fixer (El Numero debe ser asi 59177777777)</DialogDescription>
            <DialogDescription>Si registra datos vacios o mal escritos el envio no sera el esperado</DialogDescription>
          </DialogHeader>
