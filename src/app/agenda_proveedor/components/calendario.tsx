...
// 2. Recibimos las props y eliminamos la lógica de fetch interno
const Calendario: React.FC<CalendarioProps> = ({ proveedorId, nombreProveedor, profesionProveedor }) => {
  ...
  if (mostrarHorarios && fechaSeleccionada) {
    return (
      <Horario
        ...
        proveedorId={proveedorId} // Usamos el ID pasado por props
        // Construimos el objeto infoProveedor al vuelo
        infoProveedor={{ 
          nombre: nombreProveedor, 
          profesion: profesionProveedor, 
          descripcion: "" 
        }}
        onVolver={() => {
          setFechaSeleccionada(null);
  ...
  return (
    <div className="w-full">
      {/* Header simplificado, ya que la info del usuario está en el componente padre */}
      <div className="mb-6">
